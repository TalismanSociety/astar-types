...
declare module '@polkadot/types/lookup' {
    ...
    interface ShibuyaRuntimeProxyType extends Enum {
        ...
        readonly type: 'Any' | 'NonTransfer' | 'Balances' | 'Assets' | 'Governance' | 'IdentityJudgement' | 'CancelProxy' | 'DappStaking' | 'StakerRewardClaim';
    }
    ...
    interface PalletDappStakingV3Event extends Enum {
        ...
        readonly type: 'MaintenanceMode' | 'NewEra' | 'NewSubperiod' | 'DAppRegistered' | 'DAppRewardDestinationUpdated' | 'DAppOwnerChanged' | 'DAppUnregistered' | 'Locked' | 'Unlocking' | 'ClaimedUnlocked' | 'Relock' | 'Stake' | 'Unstake' | 'Reward' | 'BonusReward' | 'DAppReward' | 'UnstakeFromUnregistered' | 'ExpiredEntriesRemoved' | 'Force';
    }
    ...
    interface PalletInflationEvent extends Enum {
        ...
        readonly type: 'InflationParametersForceChanged' | 'InflationConfigurationForceChanged' | 'ForcedInflationRecalculation' | 'NewInflationConfiguration';
    }
    ...
    interface PalletDappStakingV3Call extends Enum {
        ...
        readonly type: 'MaintenanceMode' | 'Register' | 'SetDappRewardBeneficiary' | 'SetDappOwner' | 'UnbondAndUnstake' | 'WithdrawUnbonded' | 'Unregister' | 'Lock' | 'Unlock' | 'ClaimUnlocked' | 'RelockUnlocking' | 'Stake' | 'Unstake' | 'ClaimStakerRewards' | 'ClaimBonusReward' | 'ClaimDappReward' | 'UnstakeFromUnregistered' | 'CleanupExpiredEntries' | 'Force' | 'ForceSetTierParams' | 'ForceSetTierConfig';
    }
    ...
    interface ShibuyaRuntimeOriginCaller extends Enum {
        ...
        readonly type: 'Void' | 'System' | 'PolkadotXcm' | 'CumulusXcm' | 'Ethereum' | 'EthereumChecked' | 'Council' | 'TechnicalCommittee';
    }
    ...
    interface PalletDappStakingV3Error extends Enum {
        ...
        readonly type: 'Disabled' | 'ContractAlreadyExists' | 'ExceededMaxNumberOfContracts' | 'NewDAppIdUnavailable' | 'ContractNotFound' | 'OriginNotOwner' | 'NotOperatedDApp' | 'ZeroAmount' | 'LockedAmountBelowThreshold' | 'TooManyUnlockingChunks' | 'RemainingStakePreventsFullUnlock' | 'NoUnlockedChunksToClaim' | 'NoUnlockingChunks' | 'UnavailableStakeFunds' | 'UnclaimedRewards' | 'InternalStakeError' | 'InsufficientStakeAmount' | 'PeriodEndsInNextEra' | 'UnstakeFromPastPeriod' | 'UnstakeAmountTooLarge' | 'NoStakingInfo' | 'InternalUnstakeError' | 'RewardExpired' | 'RewardPayoutFailed' | 'NoClaimableRewards' | 'InternalClaimStakerError' | 'NotEligibleForBonusReward' | 'InternalClaimBonusError' | 'InvalidClaimEra' | 'NoDAppTierInfo' | 'InternalClaimDAppError' | 'ContractStillActive' | 'TooManyStakedContracts' | 'NoExpiredEntries' | 'InvalidTierParameters';
    }
