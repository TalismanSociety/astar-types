...
import type { AstarPrimitivesDappStakingSmartContract, AstarPrimitivesEthereumCheckedCheckedEthereumTx, CumulusPrimitivesParachainInherentParachainInherentData, EthereumTransactionTransactionV2, FrameSupportPreimagesBounded, PalletContractsWasmDeterminism, PalletDappStakingV3ForcingType, PalletDappStakingV3TierParameters, PalletDappStakingV3TiersConfiguration, PalletDemocracyConviction, PalletDemocracyMetadataOwner, PalletDemocracyVoteAccountVote, PalletIdentityBitFlags, PalletIdentityIdentityInfo, PalletIdentityJudgement, PalletInflationInflationConfiguration, PalletInflationInflationParameters, PalletMultisigTimepoint, PalletVestingVestingInfo, ShibuyaRuntimeOriginCaller, ShibuyaRuntimeProxyType, ShibuyaRuntimeSessionKeys, SpWeightsWeightV2Weight, XcmV3MultiLocation, XcmV3WeightLimit, XcmVersionedMultiAsset, XcmVersionedMultiAssets, XcmVersionedMultiLocation, XcmVersionedXcm } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/submittable' {
    interface AugmentedSubmittables<ApiType extends ApiTypes> {
        ...
        contracts: {
             ...
             **/
            uploadCode: AugmentedSubmittable<(code: Bytes | string | Uint8Array, storageDepositLimit: Option<Compact<u128>> | null | Uint8Array | Compact<u128> | AnyNumber, determinism: PalletContractsWasmDeterminism | 'Enforced' | 'Relaxed' | number | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                Bytes,
                Option<Compact<u128>>,
        ...
        dappStaking: {
             ...
             **/
            claimBonusReward: AugmentedSubmittable<(smartContract: AstarPrimitivesDappStakingSmartContract | {
                Evm: any;
            } | {
                Wasm: any;
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [
             ...
             **/
            claimDappReward: AugmentedSubmittable<(smartContract: AstarPrimitivesDappStakingSmartContract | {
                Evm: any;
            } | {
                Wasm: any;
            } | string | Uint8Array, era: Compact<u32> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                AstarPrimitivesDappStakingSmartContract,
                Compact<u32>
            ]>;
            /**
             ...
             **/
            force: AugmentedSubmittable<(forcingType: PalletDappStakingV3ForcingType | 'Era' | 'Subperiod' | number | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                PalletDappStakingV3ForcingType
            ]>;
            forceSetTierConfig: AugmentedSubmittable<(value: PalletDappStakingV3TiersConfiguration | {
                numberOfSlots?: any;
                slotsPerTier?: any;
                rewardPortion?: any;
                tierThresholds?: any;
            ...
            forceSetTierParams: AugmentedSubmittable<(value: PalletDappStakingV3TierParameters | {
                rewardPortion?: any;
                slotDistribution?: any;
                tierThresholds?: any;
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [
             ...
             **/
            lock: AugmentedSubmittable<(amount: Compact<u128> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                Compact<u128>
            ]>;
            /**
             ...
             * Can only be called by manager origin.
             **/
            maintenanceMode: AugmentedSubmittable<(enabled: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                bool
            ]>;
            /**
             ...
             **/
            register: AugmentedSubmittable<(owner: AccountId32 | string | Uint8Array, smartContract: AstarPrimitivesDappStakingSmartContract | {
                Evm: any;
            } | {
                Wasm: any;
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [
             ...
             **/
            setDappOwner: AugmentedSubmittable<(smartContract: AstarPrimitivesDappStakingSmartContract | {
                Evm: any;
            } | {
                Wasm: any;
            } | string | Uint8Array, newOwner: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                AstarPrimitivesDappStakingSmartContract,
                AccountId32
            ]>;
            /**
             ...
             **/
            setDappRewardBeneficiary: AugmentedSubmittable<(smartContract: AstarPrimitivesDappStakingSmartContract | {
                Evm: any;
            } | {
                Wasm: any;
            } | string | Uint8Array, beneficiary: Option<AccountId32> | null | Uint8Array | AccountId32 | string) => SubmittableExtrinsic<ApiType>, [
                AstarPrimitivesDappStakingSmartContract,
                Option<AccountId32>
            ]>;
            /**
             ...
             **/
            stake: AugmentedSubmittable<(smartContract: AstarPrimitivesDappStakingSmartContract | {
                Evm: any;
            } | {
                Wasm: any;
            } | string | Uint8Array, amount: Compact<u128> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
             ...
             **/
            unbondAndUnstake: AugmentedSubmittable<(contractId: AstarPrimitivesDappStakingSmartContract | {
                Evm: any;
            } | {
                Wasm: any;
            } | string | Uint8Array, value: Compact<u128> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
             ...
             **/
            unlock: AugmentedSubmittable<(amount: Compact<u128> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                Compact<u128>
            ]>;
            /**
             ...
             **/
            unregister: AugmentedSubmittable<(smartContract: AstarPrimitivesDappStakingSmartContract | {
                Evm: any;
            } | {
                Wasm: any;
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [
             ...
             **/
            unstake: AugmentedSubmittable<(smartContract: AstarPrimitivesDappStakingSmartContract | {
                Evm: any;
            } | {
                Wasm: any;
            } | string | Uint8Array, amount: Compact<u128> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
             ...
             **/
            unstakeFromUnregistered: AugmentedSubmittable<(smartContract: AstarPrimitivesDappStakingSmartContract | {
                Evm: any;
            } | {
                Wasm: any;
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [
        ...
        ethereumChecked: {
             ...
             **/
            transact: AugmentedSubmittable<(tx: AstarPrimitivesEthereumCheckedCheckedEthereumTx | {
                gasLimit?: any;
                target?: any;
                value?: any;
                input?: any;
        ...
        inflation: {
             ...
             **/
            forceInflationRecalculation: AugmentedSubmittable<(nextEra: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                u32
            ]>;
            /**
             ...
             **/
            forceSetInflationConfig: AugmentedSubmittable<(config: PalletInflationInflationConfiguration | {
             ...
             * Purpose of the call is testing & handling unforeseen circumstances.
             **/
            forceSetInflationParams: AugmentedSubmittable<(params: PalletInflationInflationParameters | {
        ...
        proxy: {
            ...
            addProxy: AugmentedSubmittable<(delegate: MultiAddress | {
                ...
                Address20: any;
            } | string | Uint8Array, proxyType: ShibuyaRuntimeProxyType | 'Any' | 'NonTransfer' | 'Balances' | 'Assets' | 'Governance' | 'IdentityJudgement' | 'CancelProxy' | 'DappStaking' | 'StakerRewardClaim' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                MultiAddress,
             ...
             **/
            createPure: AugmentedSubmittable<(proxyType: ShibuyaRuntimeProxyType | 'Any' | 'NonTransfer' | 'Balances' | 'Assets' | 'Governance' | 'IdentityJudgement' | 'CancelProxy' | 'DappStaking' | 'StakerRewardClaim' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array, index: u16 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                ShibuyaRuntimeProxyType,
                u32,
                u16
            ]>;
            ...
            killPure: AugmentedSubmittable<(spawner: MultiAddress | {
                ...
                Address20: any;
            } | string | Uint8Array, proxyType: ShibuyaRuntimeProxyType | 'Any' | 'NonTransfer' | 'Balances' | 'Assets' | 'Governance' | 'IdentityJudgement' | 'CancelProxy' | 'DappStaking' | 'StakerRewardClaim' | number | Uint8Array, index: u16 | AnyNumber | Uint8Array, height: Compact<u32> | AnyNumber | Uint8Array, extIndex: Compact<u32> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                MultiAddress,
                ShibuyaRuntimeProxyType,
                u16,
                Compact<u32>,
            ...
            proxy: AugmentedSubmittable<(real: MultiAddress | {
                ...
                Address20: any;
            } | string | Uint8Array, forceProxyType: Option<ShibuyaRuntimeProxyType> | null | Uint8Array | ShibuyaRuntimeProxyType | 'Any' | 'NonTransfer' | 'Balances' | 'Assets' | 'Governance' | 'IdentityJudgement' | 'CancelProxy' | 'DappStaking' | 'StakerRewardClaim' | number, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                MultiAddress,
        ...
        session: {
             ...
             * fixed.
             **/
            setKeys: AugmentedSubmittable<(keys: ShibuyaRuntimeSessionKeys | {
                aura?: any;
        ...
        unifiedAccounts: {
             ...
             **/
            claimEvmAddress: AugmentedSubmittable<(evmAddress: H160 | string | Uint8Array, signature: U8aFixed | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                H160,
                U8aFixed
            ]>;
            /**
        ...
        utility: {
             ...
             * - O(1).
             **/
            dispatchAs: AugmentedSubmittable<(asOrigin: ShibuyaRuntimeOriginCaller | {
                Void: any;
            } | {
                system: any;
            } | {
        ...
        xcAssetConfig: {
             ...
             **/
            changeExistingAssetLocation: AugmentedSubmittable<(newAssetLocation: XcmVersionedMultiLocation | {
                V2: any;
            } | {
                V3: any;
            } | string | Uint8Array, assetId: Compact<u128> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                XcmVersionedMultiLocation,
                Compact<u128>
            ]>;
            /**
             ...
             **/
            registerAssetLocation: AugmentedSubmittable<(assetLocation: XcmVersionedMultiLocation | {
                V2: any;
            } | {
                V3: any;
            } | string | Uint8Array, assetId: Compact<u128> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
             ...
             **/
            removeAsset: AugmentedSubmittable<(assetId: Compact<u128> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                Compact<u128>
            ]>;
            /**
             ...
             **/
            removePaymentAsset: AugmentedSubmittable<(assetLocation: XcmVersionedMultiLocation | {
                V2: any;
            } | {
                V3: any;
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [
             ...
             **/
            setAssetUnitsPerSecond: AugmentedSubmittable<(assetLocation: XcmVersionedMultiLocation | {
                V2: any;
            } | {
                V3: any;
            } | string | Uint8Array, unitsPerSecond: Compact<u128> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                XcmVersionedMultiLocation,
                Compact<u128>
            ]>;
            /**
