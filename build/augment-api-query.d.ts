...
import type { BTreeMap, Bytes, Null, Option, Struct, U256, U8aFixed, Vec, bool, u128, u16, u32, u64 } from '@polkadot/types-codec';
import type { AnyNumber, ITuple } from '@polkadot/types-codec/types';
import type { AccountId32, Call, H160, H256 } from '@polkadot/types/interfaces/runtime';
import type { AstarPrimitivesDappStakingSmartContract, CumulusPalletDmpQueueConfigData, CumulusPalletDmpQueuePageIndexData, CumulusPalletParachainSystemCodeUpgradeAuthorization, CumulusPalletParachainSystemRelayStateSnapshotMessagingStateSnapshot, CumulusPalletXcmpQueueInboundChannelDetails, CumulusPalletXcmpQueueOutboundChannelDetails, CumulusPalletXcmpQueueQueueConfigData, EthereumBlock, EthereumReceiptReceiptV3, EthereumTransactionTransactionV2, FpRpcTransactionStatus, FrameSupportDispatchPerDispatchClassWeight, FrameSupportPreimagesBounded, FrameSystemAccountInfo, FrameSystemEventRecord, FrameSystemLastRuntimeUpgradeInfo, FrameSystemPhase, PalletAssetsApproval, PalletAssetsAssetAccount, PalletAssetsAssetDetails, PalletAssetsAssetMetadata, PalletBalancesAccountData, PalletBalancesBalanceLock, PalletBalancesIdAmount, PalletBalancesReserveData, PalletCollatorSelectionCandidateInfo, PalletCollectiveVotes, PalletContractsStorageContractInfo, PalletContractsStorageDeletionQueueManager, PalletContractsWasmOwnerInfo, PalletContractsWasmPrefabWasmModule, PalletDappStakingV3AccountLedger, PalletDappStakingV3CleanupMarker, PalletDappStakingV3ContractStakeAmount, PalletDappStakingV3DAppInfo, PalletDappStakingV3DAppTierRewards, PalletDappStakingV3EraInfo, PalletDappStakingV3EraRewardSpan, PalletDappStakingV3PeriodEndInfo, PalletDappStakingV3ProtocolState, PalletDappStakingV3SingularStakingInfo, PalletDappStakingV3TierParameters, PalletDappStakingV3TiersConfiguration, PalletDemocracyMetadataOwner, PalletDemocracyReferendumInfo, PalletDemocracyVoteThreshold, PalletDemocracyVoteVoting, PalletEvmCodeMetadata, PalletIdentityRegistrarInfo, PalletIdentityRegistration, PalletInflationInflationConfiguration, PalletInflationInflationParameters, PalletMultisigMultisig, PalletPreimageRequestStatus, PalletProxyAnnouncement, PalletProxyProxyDefinition, PalletSchedulerScheduled, PalletTransactionPaymentReleases, PalletTreasuryProposal, PalletVestingReleases, PalletVestingVestingInfo, PalletXcmQueryStatus, PalletXcmRemoteLockedFungibleRecord, PalletXcmVersionMigrationStage, PolkadotCorePrimitivesOutboundHrmpMessage, PolkadotPrimitivesV4AbridgedHostConfiguration, PolkadotPrimitivesV4PersistedValidationData, PolkadotPrimitivesV4UpgradeRestriction, ShibuyaRuntimeSessionKeys, SpConsensusAuraSr25519AppSr25519Public, SpCoreCryptoKeyTypeId, SpRuntimeDigest, SpTrieStorageProof, SpWeightsWeightV2Weight, XcmVersionedAssetId, XcmVersionedMultiLocation } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/storage' {
    interface AugmentedQueries<ApiType extends ApiTypes> {
        ...
        dappStaking: {
             ...
             **/
            activeProtocolState: AugmentedQuery<ApiType, () => Observable<PalletDappStakingV3ProtocolState>, []> & QueryableStorageEntry<ApiType, []>;
            /**
             * Information about how much has been staked on a smart contract in some era or period.
             **/
            contractStake: AugmentedQuery<ApiType, (arg: u16 | AnyNumber | Uint8Array) => Observable<PalletDappStakingV3ContractStakeAmount>, [
                u16
             ...
             **/
            currentEraInfo: AugmentedQuery<ApiType, () => Observable<PalletDappStakingV3EraInfo>, []> & QueryableStorageEntry<ApiType, []>;
            /**
             * Information about which tier a dApp belonged to in a specific era.
             **/
            dAppTiers: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<PalletDappStakingV3DAppTierRewards>>, [
                u32
             ...
             **/
            eraRewards: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<PalletDappStakingV3EraRewardSpan>>, [
                u32
            ]> & QueryableStorageEntry<ApiType, [u32]>;
            /**
             * History cleanup marker - holds information about which DB entries should be cleaned up next, when applicable.
             **/
            historyCleanupMarker: AugmentedQuery<ApiType, () => Observable<PalletDappStakingV3CleanupMarker>, []> & QueryableStorageEntry<ApiType, []>;
            /**
             ...
             **/
            integratedDApps: AugmentedQuery<ApiType, (arg: AstarPrimitivesDappStakingSmartContract | {
                Evm: any;
            } | {
                Wasm: any;
            } | string | Uint8Array) => Observable<Option<PalletDappStakingV3DAppInfo>>, [
             ...
             **/
            ledger: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<PalletDappStakingV3AccountLedger>, [
                AccountId32
            ]> & QueryableStorageEntry<ApiType, [AccountId32]>;
            /**
             ...
             **/
            periodEnd: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<PalletDappStakingV3PeriodEndInfo>>, [
                u32
            ]> & QueryableStorageEntry<ApiType, [u32]>;
            /**
             * Information about how much each staker has staked for each smart contract in some period.
             **/
            stakerInfo: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: AstarPrimitivesDappStakingSmartContract | {
                Evm: any;
            } | {
                Wasm: any;
            } | string | Uint8Array) => Observable<Option<PalletDappStakingV3SingularStakingInfo>>, [
                AccountId32,
                AstarPrimitivesDappStakingSmartContract
             ...
             **/
            staticTierParams: AugmentedQuery<ApiType, () => Observable<PalletDappStakingV3TierParameters>, []> & QueryableStorageEntry<ApiType, []>;
            /**
             * Tier configuration user for current & preceding eras.
             **/
            tierConfig: AugmentedQuery<ApiType, () => Observable<PalletDappStakingV3TiersConfiguration>, []> & QueryableStorageEntry<ApiType, []>;
            /**
             * Generic query
             **/
            [key: string]: QueryableStorageEntry<ApiType>;
        ...
        inflation: {
             ...
             **/
            activeInflationConfig: AugmentedQuery<ApiType, () => Observable<PalletInflationInflationConfiguration>, []> & QueryableStorageEntry<ApiType, []>;
            /**
             ...
             **/
            inflationParams: AugmentedQuery<ApiType, () => Observable<PalletInflationInflationParameters>, []> & QueryableStorageEntry<ApiType, []>;
            /**
             * Generic query
             **/
            [key: string]: QueryableStorageEntry<ApiType>;
        ...
        session: {
             ...
             **/
            nextKeys: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<ShibuyaRuntimeSessionKeys>>, [
                AccountId32
            ]> & QueryableStorageEntry<ApiType, [AccountId32]>;
            /**
             ...
             **/
            queuedKeys: AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[AccountId32, ShibuyaRuntimeSessionKeys]>>>, []> & QueryableStorageEntry<ApiType, []>;
            /**
        ...
        unifiedAccounts: {
             ...
             **/
            evmToNative: AugmentedQuery<ApiType, (arg: H160 | string | Uint8Array) => Observable<Option<AccountId32>>, [
                H160
            ]> & QueryableStorageEntry<ApiType, [H160]>;
            /**
             ...
             **/
            nativeToEvm: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<H160>>, [
                AccountId32
            ]> & QueryableStorageEntry<ApiType, [AccountId32]>;
            /**
             * Generic query
        ...
        xcAssetConfig: {
             ...
             **/
            assetIdToLocation: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<XcmVersionedMultiLocation>>, [
                u128
            ]> & QueryableStorageEntry<ApiType, [u128]>;
            /**
             ...
             **/
            assetLocationToId: AugmentedQuery<ApiType, (arg: XcmVersionedMultiLocation | {
                V2: any;
            } | {
                V3: any;
             ...
             **/
            assetLocationUnitsPerSecond: AugmentedQuery<ApiType, (arg: XcmVersionedMultiLocation | {
                V2: any;
            } | {
                V3: any;
            } | string | Uint8Array) => Observable<Option<u128>>, [
